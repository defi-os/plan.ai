...
// components
import { ViewForm } from "components/open-source";
// types
    ...
    await viewsService
      ...
      .then(() => {
        ...
        setToastAlert({
          type: "success",
          title: "Success!",
          message: "Open Source created successfully.",
        });
      })
      .catch(() => {
        setToastAlert({
          type: "error",
          title: "Error!",
          message: "Open Source could not be created. Please try again.",
        });
      });
  };
    ...
    await viewsService
      ...
      .then((res) => {
        ...
        setToastAlert({
          type: "success",
          title: "Success!",
          message: "Open Source updated successfully.",
        });
      })
      .catch(() => {
        setToastAlert({
          type: "error",
          title: "Error!",
          message: "Open Source could not be updated. Please try again.",
        });
      });
  };
