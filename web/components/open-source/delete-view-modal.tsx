    ...
    await viewsService
      ...
      .then(() => {
        ...
        setToastAlert({
          type: "success",
          title: "Success!",
          message: "Open Source deleted successfully.",
        });
      })
      .catch(() => {
        setToastAlert({
          type: "error",
          title: "Error!",
          message: "Open Source could not be deleted. Please try again.",
        });
      })
      .finally(() => {
        setIsDeleteLoading(false);
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-custom-text-200">
                          Are you sure you want to delete open source-{" "}
                          <span className="break-words font-medium text-custom-text-100">
                            {data?.name}
                          </span>
                          ? All of the data related to the open source will be permanently removed. This
