...
// components
import { IssueDetailsSidebar, IssueMainContent } from "components/tasks";
// ui
      ...
      breadcrumbs={
        <Breadcrumbs>
          <Breadcrumbs.BreadcrumbItem
            title={`${truncateText(issueDetails?.project_detail.name ?? "Project", 32)} Tasks`}
            link={`/${workspaceSlug}/projects/${projectId as string}/tasks`}
            linkTruncate
          />
          <Breadcrumbs.BreadcrumbItem
            title={`Task ${issueDetails?.project_detail.identifier ?? "Project"}-${
      ...
      {error ? (
        <EmptyState
          ...
          primaryButton={{
            ...
            onClick: () => router.push(`/${workspaceSlug}/projects/${projectId}/tasks`),
          }}
        />
